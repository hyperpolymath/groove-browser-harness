...
All notable changes to `groove-browser-harness` will be documented in this file.
...
- feat: Groove browser harness — Firefox extension for localhost service discovery
...
- fix: update Groove port table — gitbot-fleet 8080, panic-attack rename
