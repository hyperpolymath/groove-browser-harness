...
= Troubleshooting — groove-browser-harness
:revdate: 2026-MM-DD
...
* `https://github.com/hyperpolymath/groove-browser-harness/issues?q=is%3Aissue+<your symptom>` — has anyone hit this before?
