...
= Contributing — groove-browser-harness
:revdate: 2026-MM-DD

== Audience

Developers working *on* `groove-browser-harness`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/groove-browser-harness.git
cd groove-browser-harness
...
* Bugs in `groove-browser-harness`: file at `hyperpolymath/groove-browser-harness/issues`.
